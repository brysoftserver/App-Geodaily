// ============================================================
// GEODAILY — Firma del Beneficiario (pantalla individual)
// ============================================================
...
const FirmaBeneficiarioScreen: React.FC<Props> = ({ navigation }) => {
  const { setFirmaBeneficiario, formularioActual } = useForm();
  const insets = useSafeAreaInsets();

  const [firma, setFirmaLocal] = useState<string | null>(
    formularioActual?.firma_beneficiario || null
  );
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + SPACING.lg }]}>
        <View style={styles.headerRow}>
          <Text style={styles.title}>✍️ Firma del Beneficiario</Text>
          {firma && (
...
export default FirmaBeneficiarioScreen;
